...
DEFINE_FIND_CLASS(KXlog, "com/common/livestream/log/Xlog")
...
//JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_appenderOpen
...
//
//}
    DEFINE_FIND_STATIC_METHOD(KXlog_initWithMultipathWithLevel, KXlog, "init", "(ILjava/lang/String;)V")
    JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_init
    (JNIEnv *env, jclass, jint level, jstring _log_dir) {
        if (NULL == _log_dir) {
            return;
        }
...
JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_uninit(JNIEnv *env, jobject) {
	appender_close();
}

//JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_appenderFlush(JNIEnv *env, jobject, jboolean _is_sync) {
//	if (_is_sync) {
//		appender_flush_sync();
//	} else {
//		appender_flush();
//	}
//}
    JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_flushLog(JNIEnv *env, jobject) {
        appender_flush_sync();
    }
    
    
//DEFINE_FIND_STATIC_METHOD(KXlog_logWrite, KXlog, "logWrite", "(Lcom/tencent/mars/xlog/Xlog$XLoggerInfo;Ljava/lang/String;)V")
//DEFINE_FIND_STATIC_METHOD(KXlog_logWrite, KXlog, "logWrite", "(Lcom/common/livestream/log/Xlog$XLoggerInfo;Ljava/lang/String;)V")
//    
//    
//JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_logWrite
...
//}
    ...
    DEFINE_FIND_STATIC_METHOD(KXlog_nativeWriteObj, KXlog, "nativeWriteObj", "(Lcom/common/livestream/log/Xlog$XLoggerInfo;Ljava/lang/String;)V")
    JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_nativeWriteObj
    (JNIEnv *env, jclass, jobject _log_info, jstring _log) {
...
//JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_logWrite2
...
//	}
//}
    DEFINE_FIND_STATIC_METHOD(KXlog_nativeWrite, KXlog, "nativeWrite", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;IIJJLjava/lang/String;)V")
    JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_nativeWrite
    (JNIEnv *env, jclass, int _level, jstring _tag, jstring _filename,
     jstring _funcname, jint _line, jint _pid, jlong _tid, jlong _maintid, jstring _log) {
...
JNIEXPORT jint JNICALL Java_com_common_livestream_log_Xlog_getLogLevel
  (JNIEnv *, jobject) {
	return xlogger_Level();
}

DEFINE_FIND_STATIC_METHOD(KXlog_setLogLevel, KXlog, "setLogLevel", "(I)V")
JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_setLogLevel
...
//JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_setAppenderMode
...
//}
    ...
    //JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_setConsoleLogOpen
    //  (JNIEnv *env, jclass, jboolean _is_open) {
    //	appender_set_console_log((bool)_is_open);
    //}
    DEFINE_FIND_STATIC_METHOD(KXlog_showInConsole, KXlog, "showInConsole", "(Z)V")
    JNIEXPORT void JNICALL Java_com_common_livestream_log_Xlog_showInConsole
    (JNIEnv *env, jclass, jboolean _is_open) {
        appender_set_console_log((bool)_is_open);
    }
